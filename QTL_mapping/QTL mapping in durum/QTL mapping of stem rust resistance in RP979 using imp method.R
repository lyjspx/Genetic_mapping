...
setwd("/Users/xuehui.li/Desktop/XL/research/crops/durum_wheat/p2_Integrated genetic linkage map in tetraploid wheat/Rqtl mapping/RP979")

#load packages "qtl"
RP979=read.cross("csvr", "/Users/xuehui.li/Desktop/XL/research/crops/durum_wheat/p2_Integrated genetic linkage map in tetraploid wheat/Rqtl mapping/RP979", "RP979_rotated_Rqtl_6624mapped_JoinMap.csv", na.strings=c("-"), estimate.map = FALSE, crosstype = "riself")
...
operm.imp.TTKSK <- scanone(RP979.sim, pheno.col=2, method="imp", n.perm=1000)
